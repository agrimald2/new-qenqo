...
<template>
    <StudentsLayout>
        <SectionMain>
            <h2 class="text-2xl font-semibold mb-4 text-white text-center main-font">Reserva tu Cita Nutricionista</h2>
            <div class="p-4">
                <div class="mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    <div v-for="timeSlot in availableTimes" :key="timeSlot.id"
                        ...
                        <div class="p-4 ">
                            <div class="font-bold text-gray-800 secondary-font yellow-qenqo-text text-center">{{ timeSlot.startTime }} -
...
export default {
    ...
    methods: {
        ...
        bookAppointment(timeSlot) {
            window.location.href = '/students/appointmentConfirmationNutri';
