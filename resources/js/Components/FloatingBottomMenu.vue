...
import { mdiCalendar, mdiListBox } from "@mdi/js";
</script>

<template>
    <div
        class="fixed z-50 w-full h-14 max-w-lg -translate-x-1/2 bg-black border border-gray-800 rounded-full bottom-6 left-1/2">
        <div class="grid h-full max-w-lg grid-cols-5 mx-auto">
            <button data-tooltip-target="tooltip-home" type="button" @click="goTo('/students/dashboard')"
            ...
            <button data-tooltip-target="tooltip-wallet" type="button"  @click="goTo('/students/buyRates')"
            ...
            <div class="flex items-center justify-center"> 
                <button data-tooltip-target="tooltip-new" type="button"  @click="goTo('/students/scheduleAppointment')"
                    class="inline-flex items-center justify-center w-10 h-10 font-medium bg-blue-600 rounded-full hover:bg-blue-700 group focus:ring-4 focus:ring-blue-300 focus:outline-none dark:focus:ring-blue-800">

                    <BaseIcon :path="mdiCalendar" size="24" />
            ...
            <button data-tooltip-target="tooltip-settings" type="button" @click="goTo('/students/appointments')"
                class="inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group">
                <BaseIcon :path="mdiListBox" size="32" style="color: gray;" />
